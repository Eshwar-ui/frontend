...
class GeneratePayslipDialog extends StatefulWidget {
  ...
  @override
  State<GeneratePayslipDialog> createState() => _GeneratePayslipDialogState();
}

class _GeneratePayslipDialogState extends State<GeneratePayslipDialog> {
